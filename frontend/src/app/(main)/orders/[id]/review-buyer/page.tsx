...
export default function BuyerReviewPage() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            if (txn.seller_id !== user?.user_id) {
                setNotAuthorized(true);
                return;
            }

            if (reviewRes && reviewRes.data?.reviewer_id === user?.user_id) {
    ...
    if (notAuthorized) {
        return (
            <div className="p-6 flex flex-col items-center justify-center min-h-[60vh] gap-3">
                ...
                <h2 className="text-xl font-black text-gray-800">Not Authorized</h2>
                <p className="text-sm text-gray-400 text-center">Only the seller can review the buyer for this order.</p>
    ...
    if (alreadyReviewed) {
        return (
            <div className="p-6 flex flex-col items-center justify-center min-h-[60vh] gap-3">
                ...
                <p className="text-sm text-gray-400 text-center">You've already submitted a review for this buyer.</p>
                <button onClick={() => router.push('/orders')} className="text-CropLink-primary font-bold text-sm mt-2">← Back to Orders</button>
            </div>
        );
    }
    ...
    return (
        <div className="p-6 max-w-lg mx-auto">
            ...
            <div className="flex justify-between items-start mb-6">
                <div>
                    <h1 className="text-xl font-black text-gray-800">Review the Buyer</h1>
