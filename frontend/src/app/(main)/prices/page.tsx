...
export default function PricesDashboard() {
                ...
                <div className="p-5 pb-4 bg-white shadow-sm mb-2 rounded-b-3xl shrink-0">
                    ...
                    <div className="flex items-center justify-between mt-2 p-3 bg-[#f7f5f0] rounded-xl border border-gray-100 shadow-inner">
                        <div className="flex flex-col text-center">
                            ...
                            <span className="text-sm font-black text-gray-700">{selectedMarketData.currency} {selectedMarketData.min_price}</span>
                        </div>
                        ...
                        <div className="flex flex-col text-center">
                            ...
                            <span className="text-sm font-black text-[#2d5a3d]">{selectedMarketData.currency} {selectedMarketData.avg_price}</span>
                        </div>
                        ...
                        <div className="flex flex-col text-center">
                            ...
                            <span className="text-sm font-black text-gray-700">{selectedMarketData.currency} {selectedMarketData.max_price}</span>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="min-h-full bg-gray-50 flex flex-col pb-6 overflow-y-auto">
                        ...
                        return (
                            ...
                            >
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <span className="text-xs font-black text-[#2d5a3d]">{item.currency} {item.avg_price} <span className="text-[9px] font-bold text-gray-400">AVG</span></span>
                                </div>
                                ...
                                <div className="relative pt-6 pb-2 px-1">
                                    ...
                                    <div className="flex justify-between mt-6">
                                        <div className="flex flex-col"><span className="text-[8px] font-bold text-gray-400 uppercase">Min</span><span className="text-xs font-black text-gray-700">{item.currency} {item.min_price}</span></div>
                                        <div className="flex flex-col text-right"><span className="text-[8px] font-bold text-gray-400 uppercase">Max</span><span className="text-xs font-black text-gray-700">{item.currency} {item.max_price}</span></div>
                                    </div>
                                </div>
                            </div>
                        );
